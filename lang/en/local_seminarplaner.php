...
$string['editunitdeleteconfirm'] = 'Delete the seminar unit "{$a}" from this set for good? Activities that already use it keep their own copy.';
$string['editunitdeleted'] = 'Seminar unit "{$a}" deleted.';
$string['editunitdeletelogged'] = 'Seminar unit "{$a}" deleted.';
