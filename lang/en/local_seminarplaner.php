...
$string['importexistingsettitle'] = 'Add seminar units to an existing entry';
$string['importexistingset_desc'] = 'Imports seminar units into an existing global entry in draft status.';
