...
$string['editunitdeleteconfirm'] = 'Die Seminareinheit „{$a}" endgültig aus dieser Sammlung löschen? Aktivitäten, die sie bereits verwenden, behalten ihre eigene Kopie.';
$string['editunitdeleted'] = 'Seminareinheit „{$a}" gelöscht.';
$string['editunitdeletelogged'] = 'Seminareinheit „{$a}" gelöscht.';
