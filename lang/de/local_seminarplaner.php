...
$string['importnewsettitle'] = 'Neue globale Methoden-Sammlung hochladen';
$string['importnewset_desc'] = 'Legt eine neue Methoden-Sammlung im Entwurfsstatus an und importiert die Seminareinheiten aus der Datei.';
$string['importexistingsettitle'] = 'Seminareinheiten zu bestehender Methoden-Sammlung hinzufügen';
$string['importexistingset_desc'] = 'Importiert Seminareinheiten in eine bestehende Methoden-Sammlung im Entwurfsstatus.';
...
$string['importstep1existingset'] = 'Schritt 1: Bestehende Methoden-Sammlung auswählen';
$string['importstep2file'] = 'Schritt 2: Importdatei angeben';
$string['importstep3run'] = 'Schritt 3: Import ausführen';
$string['importnewsetsubmit'] = 'Neue Methoden-Sammlung importieren';
$string['importexistingsetsubmit'] = 'In bestehende Methoden-Sammlung importieren';
$string['importnewsetok'] = '{$a->count} Seminareinheiten importiert. Neue Methoden-Sammlung erstellt.';
$string['reactivateglobalset'] = 'Reaktivieren (zu Entwurf)';
$string['exportmoddata'] = 'Methoden-Sammlung exportieren (mod_data)';
$string['targetdraftset'] = 'Ziel-Sammlung (Entwurf)';
